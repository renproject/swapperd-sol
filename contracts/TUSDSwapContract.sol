...
/// @notice Initiates the atomic swap.
    ...
    function initiate(
        ...
        uint256 balanceBefore = CompatibleERC20(TOKEN_ADDRESS).balanceOf(address(this));
        CompatibleERC20(TOKEN_ADDRESS).transferFrom(msg.sender, address(this), _value);
        uint256 balanceAfter = CompatibleERC20(TOKEN_ADDRESS).balanceOf(address(this));
